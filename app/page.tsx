...
import { PRODUCTS, WHATS_INCLUDED, CANCELLATION_POLICY } from "@/data/marina";
...
function Stars({ count = 5 }: { count?: number }) {
  return (
    <span className="text-sand-500 text-base tracking-wider" aria-label={`${count} out of 5 stars`}>
      {"★".repeat(count)}
    </span>
  );
}
    ...
    <>
      ...
      <Section tone="pine" spacing="default">
        <div className="grid gap-10 md:grid-cols-3 md:gap-12">
          ...
          <Reveal>
            <div>
              <h3 className="text-display-sm font-medium text-sand-100">
                What&apos;s included
              </h3>
